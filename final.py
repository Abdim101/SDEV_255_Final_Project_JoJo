        ...
        if F_name and L_name:
            if birthday and email and phone:
                ...
                table_create_query = '''CREATE TABLE IF NOT EXISTS Customer_Data 
                    (F_name TEXT, L_name TEXT, T_box TEXT, birthday TEXT, email TEXT, 
                    phone TEXT)
            '''
                conn.execute(table_create_query)

                data_insert_query = '''INSERT INTO Customer_Data (F_name, L_name, T_box, birthday, email, phone) VALUES (?, ?, ?, ?, ?, ?)'''
                data_insert_tuple = (F_name, L_name, T_box,
